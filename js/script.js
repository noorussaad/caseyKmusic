 ...
 $(document).ready(function(){
   ...
   //MBP.hideUrlBarOnLoad();
      ...
      var runFlexsliders = function(){
         ...
         var loadUpperMenu = function() {
            var content = '<li><a href="about.html"><img src="img/buttons/m/about.png" alt="About"></a></li>';
            content += '<li><a href="music.html"><img src="img/buttons/m/music.png" alt="Music"></a></li>';
            content += '<li><a href="gallery.html"><img src="img/buttons/m/gallery.png" alt="Gallery"></a></li>';
            content += '<li><a href="videos.html"><img src="img/buttons/m/videos.png" alt="Videos"></a></li>';
            content += '<li><a href="https://www.facebook.com/pages/Casey-K/154121501363111" target="_blank"><img src="img/buttons/m/facebook.png" alt="Facebook"></a></li>';
            content += '<li><a href="https://twitter.com/CaseyKaybaybay" target="_blank"><img src="img/buttons/m/twitter.png" alt="Twitter"></a></li>';
            content += '<li><a href="https://itunes.apple.com/us/album/in-tine-ep/id616984488" target="_blank"><img src="img/buttons/m/download.png" alt="Downloads"></a></li>';
            content += '<li><a href="mailto:noorussaad@gmail.com"><img src="img/buttons/m/contact.png" alt="Contact"></a></li>';
            $('.upperMenuUI').append(content);
         }
